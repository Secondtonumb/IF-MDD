...
# from HF
# asr_model_path = "Haopeng/iqra_CROTTC_conf_k7"
# asr_model_path = "Haopeng/iqra_CROTTC_conf_k3"
# asr_model_path = "Haopeng/iqra_CTC_conf_k3"
asr_model_path = "Haopeng/iqra_OTTC"
# asr_model_path = "Haopeng/iqra_CRCTC"
asr_model = MyEncoderASR.from_hparams(source=asr_model_path, hparams_file="inference.yaml")
...
# Structured output: inference_outputs/{file_id}/{model_name}/
output_base = Path("inference_outputs")
output_dir = output_base / file_id / f"{asr_model_parent}_{asr_model_name}"
