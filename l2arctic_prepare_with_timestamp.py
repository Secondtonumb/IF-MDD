...
def get_data_from_utt(tg, wav_file, text_file, spk):
    ...
    _, target_intervals = get_phoneme_intervals(tg, keep_artificial_sil=False, rm_repetitive_sil=True)
...
def get_phoneme_intervals(tg, keep_artificial_sil=False, rm_repetitive_sil=True):
    ...
    return canonical_intervals, perceived_intervals
...
def remove_repetitive_sil_ver2(phone_list):
    ...
    remove_sil_mask = [True if x[2] == "sil" else False for x in phone_list]
