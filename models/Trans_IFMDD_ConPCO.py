...
class Trans_IFMDD_ConPCO(sb.Brain):
    ...
    def compute_forward(self, batch, stage):
        ...
        if sb.Stage.TRAIN == stage:
            ...
            # print("SSL model final layer norm bias:")
            
            # # compare
            # x1 = self.modules.perceived_ssl.model.state_dict()['encoder.layers.23.final_layer_norm.bias']
            # x1_ = self.hparams.pretrainer.loadables['perceived_ssl'].state_dict()['model.encoder.layers.23.final_layer_norm.bias']
            
            
            # print("proj first layer bias:")
            
            # x2 = self.modules.enc.state_dict()['1.bias']
            # x2_ = self.hparams.pretrainer.loadables['model'].state_dict()['0.1.bias']
            
            # print("Conformer Encoder conv weight:")
            # self.modules.ConformerEncoder.state_dict()['layers.0.convolution_module.conv.weight']
            # self.hparams.pretrainer.loadables['model'].state_dict()['1.layers.0.convolution_module.conv.weight']
            # print("CTC linear weight:")
            # self.modules.ctc_lin.state_dict()[''w.weight']
            # self.hparams.pretrainer.loadables['model'].state_dict()['2.w.weight']
    ...
    def on_fit_start(self):
        ...
        if pretrainer is not None and getattr(self.hparams, 'resume_from_folder', False):
            ...
            pretrainer.load_collected()
            # self.modules.perceived_ssl.model.state_dict()['encoder.layers.23.final_layer_norm.bias']
            # pretrainer.loadables['perceived_ssl'].state_dict()['model.encoder.layers.23.final_layer_norm.bias']
            # self.modules.ConformerEncoder.state_dict()['layers.0.convolution_module.conv.weight']
            # pretrainer.loadables['model'].state_dict()['1.layers.0.convolution_module.conv.weight']
