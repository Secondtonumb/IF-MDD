...
class TransformerMDD_TP_encdec_errclass_ConPCO(sb.Brain):
    ...
    def compute_forward(self, batch, stage):
        ...
        if sb.Stage.TRAIN == stage:
            ...
            # pdb.set_trace()
            # check tgt embedding
            #  tgt_emb = self.modules.TransASR.custom_tgt_module(targets_bos)
            #  tgt_emb.mean() tgt_emb.std()
            #  tgt_conPCO_emb = self.modules.conpco_proj_perceived_phn_feat(targets_bos)
            #  tgt_conPCO_emb.mean() tgt_conPCO_emb.std()
